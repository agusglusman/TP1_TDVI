...
prueba1 <- mejor_arbol(a=15, b=30, c=20,    x=10, y=20,   z=1,    train_data=train_data, valid_data=valid_data)
prueba2 <- mejor_arbol(a=20, b=30, c=20,    x=15, y=20,   z=1,    train_data=train_data, valid_data=valid_data)
...
prueba6 <- mejor_arbol(a=30, b=500, c=4000, x=25, y=490,  z=3990, train_data=train_data, valid_data=valid_data)
prueba7 <- mejor_arbol(a=25, b=5000,c=400,  x=20, y=4990, z=390,  train_data=train_data, valid_data=valid_data)
